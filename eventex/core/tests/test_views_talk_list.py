...
class TalkListTest(TestCase):
    ...
    def test_html(self):
        ...
        self.assertContains(self.resp, u'/palestrantes/filipe-manuel/', 2)
        self.assertContains(self.resp, u'Lorem Ipsum', 2)
        self.assertContains(self.resp, u'Filipe Manuel', 2)
